...
// PricingModel定义了不同大模型的计费标准(单位:美元/1M Tokens
...
// NewCostTracker构造函数:接收一个现有的 Provider,返回一个被监控的Provider。非常经典的装饰器模式
...
// Generate 实现了 LLMProvider接口!这意味着它可以被无缝注入到Main Loop中
