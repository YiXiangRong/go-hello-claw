...
// PromptComposer 负责根据工作区环境动态生成System Prompt
...
// Build 组装并返回一条完整的RoleSystem消息
func (c *PromptComposer) Build() schema.Message {
	var promptBuilder strings.Builder

	// 1.极简内核：仅确立基本身份与最低线的红线纪律
	promptBuilder.WriteString(`# 核心身份
你名叫 go-hello-claw，一个由驾驭工程驱动的骨灰级研发助手。
